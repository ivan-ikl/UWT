...
namespace UWT.Models.Extensions {
    public static class Filtering 
    {
        ...
        public static IQueryable<Category> Filter(this IQueryable<Category> items, string userId)
        {
            return items.Where(i => i.Shop != null && i.Shop.Owner != null && i.Shop.Owner.Id == userId);
        }

        public static IQueryable<Product> Filter(this IQueryable<Product> items, string userId)
        {
            return items.Where(i => i.Shop != null && i.Shop.Owner != null && i.Shop.Owner.Id == userId);
        } 
    }
