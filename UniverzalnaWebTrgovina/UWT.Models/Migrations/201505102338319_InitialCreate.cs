    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Basket_Id = c.Long(nullable: false),
                ...
                c => new
                    {
                        ...
                        ProfileImage_Id = c.Long(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("UWT.Images", t => t.ProfileImage_Id)
                ...
                c => new
                    {
                        ...
                        DateCreated = c.DateTime(nullable: false),
                        Owner_Id = c.String(nullable: false, maxLength: 128),
                        PageLayout_Id = c.Long(nullable: false),
                        BackgroundImage_Id = c.Long(nullable: false),
                        Logo_Id = c.Long(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("UWT.AspNetUsers", t => t.Owner_Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Search_Id = c.Long(nullable: false),
                        Product_Id = c.Long(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("UWT.AspNetUsers", "ProfileImage_Id", "UWT.Images");
            ...
            DropIndex("UWT.AspNetUsers", new[] { "ProfileImage_Id" });
